// $ANTLR 3.3 Nov 30, 2010 12:50:56 be/kuleuven/cs/distrinet/jnome/input/parser/Java.g 2015-05-27 13:53:48
...
public class JavaParser extends ChameleonANTLR3Parser {
    ...
    public final JavaParser.stuff_return stuff() throws RecognitionException {
    	...
    	retval.tree = (Object)adaptor.errorNode(input, retval.start, input.LT(-1), re);
            ...
            if ( state.backtracking>0 ) { memoize(input, 418, stuff_StartIndex); }
        }
        return retval;
    }
    // $ANTLR end "stuff"
