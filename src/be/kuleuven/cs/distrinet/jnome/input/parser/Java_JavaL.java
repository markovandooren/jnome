// $ANTLR 3.3 Nov 30, 2010 12:50:56 JavaL.g 2016-11-10 15:28:38
...
public class Java_JavaL extends Lexer {
    ...
    // delegates
    // delegators
    public JavaLexer gJava;
    public JavaLexer gParent;

    public Java_JavaL() {;} 
    public Java_JavaL(CharStream input, JavaLexer gJava) {
        this(input, new RecognizerSharedState(), gJava);
    }
    public Java_JavaL(CharStream input, RecognizerSharedState state, JavaLexer gJava) {
        super(input,state);
